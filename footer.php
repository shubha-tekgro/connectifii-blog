<footer class="relative w-full px-6 py-10 text-neutral-50 sm:px-10 md:px-14 xl:px-20">
    ...
    <img src="assets/images/footer-bg.svg" alt="" aria-hidden="true"
    ...
    <div class="grid gap-12 lg:grid-cols-[auto_1fr]">
        ...
        <div class="flex flex-col items-start">
            <img src="assets/logo-icon-white.webp" alt="CONNECTIFII logo" class="w-24 object-contain lg:w-16" />
            <img src="assets/logo-white.webp" alt="CONNECTIFII tagline" class="mt-6 w-64 object-contain lg:w-48" />
        </div>
    ...
    <div class="mt-10 flex flex-col items-start gap-6 border-t border-gray-600 pt-6 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex items-center gap-4">
            <a href="https://www.facebook.com/connectifii" target="_blank">
                <img src="assets/icons/facebook.svg" class="w-6 sm:w-8" alt="facebook icon">
            </a>
            <a href="https://www.linkedin.com/company/connectifii-partnerships/" target="_blank">
                <img src="assets/icons/linked.svg" class="w-6 sm:w-8" alt="linkedin icon">
            </a>
            <a href="https://www.instagram.com/connectifii/" target="_blank">
                <img src="assets/icons/instagram.svg" class="w-6 sm:w-8" alt="instagram icon">
            </a>
        </div>
        ...
        <div class="flex items-center gap-3">
            ...
            <img src="assets/tekgro.webp" class="w-[90px] object-contain" alt="Marketing partner logo">
        </div>
    </div>
    ...
    <section class="mt-8 text-left text-xs text-gray-400">
        <div class="flex items-start gap-4">
            <img src="assets/images/aboriginal-flag.webp" class="w-12 object-contain" alt="Aboriginal flag" />
